  ...
  <div class="sg-info">               
    ...
    <div class="sg-colors sg-section">
      <h2 class="sg-h2"><a id="sg-colors" class="sg-anchor">Colors</a></h2>
        ...
        <div class="sg-color sg-color--b"><span class="sg-color-swatch"><span class="sg-animated">#3b6ab0</span></span></div>
    ...
    <div class="sg-font-stacks sg-section">
      ...
      <p class="sg-font sg-font-primary">"HelveticaNeue-Light", "Helvetica Neue Light", "Helvetica Neue", Helvetica, tahoma, arial, sans-serif;</p>
